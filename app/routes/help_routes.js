  ...
  app.post('/help', (req, res) => {
   ...
   let responseJson = JSON.stringify(responseObj);
    setTimeout(function(){
     ...
     app.get('/getCoverage', (req, res) => {
      let responseObj = sourceData;
      //console.log(sourceData)
      // let responseJson = querystring.stringify(responseObj);
      let responseJson = JSON.stringify(responseObj);
   ...
   app.post('/apply', (req, res) => {
     //console.log(req.body);
     let jsonObjBody = querystring.stringify(req.body);
     //console.log(jsonObjBody);
     //testing
     // let responseObj = {
     //   "status": "ok",
     //   "contact":"2222222222222",
     ...
     //    res.send(responseJson);
      //prod
     db.collection('applications').save(req.body, (err, result) => {
      ...
      let responseJson = querystring.stringify(responseObj);
         res.send(responseJson);//// res.redirect('/')
        });
    });
};
